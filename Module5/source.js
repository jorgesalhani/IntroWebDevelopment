...
// EXERCISE 4 - Highlight words (CHANGE BY CLICK)
let newButton = document.createElement('button');
newButton.classList.add('highlight');
newButton.innerHTML = 'HIGHLIGHT WORDS';
heading.appendChild(newButton);

document.getElementsByClassName('highlight')[0].addEventListener('click', changeByClick);

// document.getElementsByClassName('highlight').addEventListener('click', changeByClick() {
